...
<body class="layui-layout-body">
    ...
    <div class="container registerBox">
        <div class="containerBox">
            ...
            <div class="input">
                <img src="/job/cauc_zsb2/zsb/Public/Home/images/user-name.png" class="userImg">
                <input class="input-text" type="text" name="user_name" placeholder="请输入姓名 (须与高考报名一致)">
            </div>
            <div class="input">
                <img src="/job/cauc_zsb2/zsb/Public/Home/images/sfzh.png" class="idCardImg">
                <input class="input-text" type="text" name="id_number" placeholder="请输入身份证号">
            </div>
            <div class="input">
                <img src="/job/cauc_zsb2/zsb/Public/Home/images/user-password.png" class="userImg">
            ...
            <div class="input">
                <img src="/job/cauc_zsb2/zsb/Public/Home/images/sjh.png" class="mobileImg">
