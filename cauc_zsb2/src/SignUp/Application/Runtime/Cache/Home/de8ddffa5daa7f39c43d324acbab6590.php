...
<body class="layui-layout-body">
    ...
    <div class="user-center">
        ...
        <div class='userBox'>
            <?php if(($kckb['registration_switch'] == 1) and ($kckb['bm_type'] == 3)): ?><a href="<?php echo U('Index/AeronauticalAttendants');?>" class="list">
                    <div class="picture-container">
                        <img src="/job/cauc_zsb2/zsb/Public/Home/images/kckb.png">
                    </div>
            ...
            <?php if(isset($gsp)): ?><a href="<?php echo U('Index/highLevelAthletes');?>" class="list">
                <div class="picture-container">
                    <img src="/job/cauc_zsb2/zsb/Public/Home/images/ydy.png">
                </div>
                <div style="text-align: center;">
                    <p>高水平运动员</p>
                    <p>Senior athlete</p>
        ...
        <?php if(($zzy['registration_switch'] == 1) and ($zzy['bm_type'] == 1)): ?><a  href="javascript:;" data-id="1" class="list getInto">
                <div class="picture-container">
                    <img src="/job/cauc_zsb2/zsb/Public/Home/images/zzy.png">
                </div>
                <div style="text-align: center;">
                    <p>转专业</p>
        ...
        <?php if(($zo['registration_switch'] == 1) and ($zo['bm_type'] == 2)): ?><a  href="javascript:;" data-id="2" class="list last-child getInto">
                <div class="picture-container">
                    <img src="/job/cauc_zsb2/zsb/Public/Home/images/zoxb.png">
                </div>
                <div style="text-align: center;">
                    <p>中欧选拔</p>
    ...
    <div class="user-center1" style="display:none;">
        <div class='userBox'>
            <?php if(($kckb['registration_switch'] == 1) and ($kckb['bm_type'] == 3)): ?><a href="<?php echo U('Index/AeronauticalAttendants');?>" class="list">
                    <img src="/job/cauc_zsb2/zsb/Public/Home/images/cabin_icon.png">
                </a><?php endif; ?>
            <a href="<?php echo U('Index/highLevelAthletes');?>" class="list">
                <img src="/job/cauc_zsb2/zsb/Public/Home/images/athele_icon.png">
            </a>
            <?php if(($zzy['registration_switch'] == 1) and ($zzy['bm_type'] == 1)): ?><a href="javascript:;" data-id="1" class="list getInto">
                    <img src="/job/cauc_zsb2/zsb/Public/Home/images/shift_icon.png">
                </a><?php endif; ?>
            <?php if(($zo['registration_switch'] == 1) and ($zo['bm_type'] == 2)): ?><a href="javascript:;" data-id="2" class="list getInto">
                    <img src="/job/cauc_zsb2/zsb/Public/Home/images/select_icon.png">
                </a><?php endif; ?>
        </div>
    </div>
