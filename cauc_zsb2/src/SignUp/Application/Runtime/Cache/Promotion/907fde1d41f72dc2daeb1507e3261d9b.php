...
<div class="body grey">
    <div class="register pad fff bottom" style="min-height:400px;">
        <div class="rtitle">
            <span class="t1">个人资料</span>
            <span class="t2">代码：<?php echo ($vo["id"]); ?></span>
        </div>
        <div class="infobox">
            <ul class="uleft">
                <li>姓名：<?php echo ($vo["realname"]); ?></li>
                <li>性别：<?php echo ($vo["sex"]); ?></li>
                <li>籍贯：<?php echo ($vo["native_place"]); ?></li>
            </ul>
            <ul class="uleft">
                <li>校龄：<?php echo ($vo["school_age"]); ?>年</li>
                <li>毕业院校：<?php echo ($vo["graduate"]); ?></li>
                <li>所属部门：<?php echo ($vo["collegeName"]); ?></li>
            </ul>
        </div>
    </div>
</div>
