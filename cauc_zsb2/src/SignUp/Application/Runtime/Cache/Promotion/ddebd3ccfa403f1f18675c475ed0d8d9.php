...
<div class="body grey">
    <div class="register pad fff bottom" style="min-height:500px;">
        ...
        <div class="historylist">
            <?php if(isset($dataList)): if(is_array($dataList)): $i = 0; $__LIST__ = $dataList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><a href="<?php echo U('Signup/detail',['id'=>$vo['id']]);?>" class="itembox">
