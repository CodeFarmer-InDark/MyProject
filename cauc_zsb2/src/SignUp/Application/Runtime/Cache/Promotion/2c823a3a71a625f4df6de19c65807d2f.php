...
<div class="body grey">
    <div class="register pad fff bottom" style="min-height:500px;">
        <div class="stitle">
            <span class="s1">学校列表（<?php echo ($year); ?>年<?php if(isset($pname)): ?>-<?php echo ($pname); endif; ?>）</span>
            <a href="<?php echo U('SignSecond/select');?>" class="s2"><< 返回</a>
        </div>
        <form action="<?php echo U('SignSecond/doCommand');?>" method="post" >
            <table class="bmlist">
                <thead>
                <tr>
                ...
                <?php if(isset($dataList)): ?><tfoot>
                    ...
                    <tr><td></td></tr>
                    <tr><td colspan="4"></td></tr><?php endif; ?>
                </tbody>
            </table>
