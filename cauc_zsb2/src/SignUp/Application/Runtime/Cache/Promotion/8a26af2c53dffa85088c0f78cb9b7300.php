...
<center>
	<div id="content">
		...
		<!-- 成功-->
		<?php if(($status) == "1"): if(isset($message)): ?><h3><a style="background:transparent url(/cauc_zs3/lqgl/Public/Admin/success.gif) no-repeat scroll left center;padding:15px 0px 15px 60px;"><?php echo ($msgTitle); ?></a></h3>
				<h4><a style="padding:15px 0px 15px 60px;"><?php echo ($message); ?></a></h4><?php endif; endif; ?>

		<!--失败-->
		<?php if(($status) == "0"): if(isset($error)): ?><h3><a  style="background:transparent url(/cauc_zs3/lqgl/Public/Admin/error.gif) no-repeat scroll left center;color:#E26000;padding:15px 0px 15px 60px;"><?php echo ($msgTitle); ?></a></h3>
				<h4><a style="padding:15px 0px 15px 60px;"><?php echo ($message); ?></a></h4><?php endif; endif; ?>

		<?php if(isset($notips)): else: ?>
