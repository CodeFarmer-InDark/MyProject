...
<div class="breadcrumbs">
    <div class="bfont">当前位置：<a href="__ROOT__/">首页</a>><a href="<?php echo U('College/index',array('id'=>44));?>"><?php echo ($moduleTitle); ?></a>><a href="<?php echo U('College/major',array('id'=>45));?>">专业一览</a></div>
</div>
<div class="re-breadcrumbs">
    <div class="bfont"><a href="__ROOT__/">首页 </a>> <a href="<?php echo U('College/index',array('id'=>44));?>"><?php echo ($moduleTitle); ?></a> > <a href="<?php echo U('College/major',array('id'=>45));?>">专业一览</a></div>
</div>
<div class="listmain">
    <div class="cont_v">
        <div class="vd-title" style="margin-bottom:20px;">专业一览</div>
        <table  cellspacing="0" cellpadding="0">
            ...
            <?php if(isset($dataList)): if(is_array($dataList)): $i = 0; $__LIST__ = $dataList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                        <td class="collegeName"><?php echo ($vo["college"]); ?></td>
                        <td class="majorName"><?php echo ($vo["zymc"]); if($vo['major'] != ''): echo ($vo["major"]); endif; ?></td>
                        <td class="otherName"><?php echo ($vo["length"]); ?></td>
                        <td class="otherName"><?php echo ($vo["type"]); ?></td>
                        <td class="otherName"><?php echo ($vo["target"]); ?></td>
                        <td class="otherName"><?php echo ($vo["fee"]); ?></td>
                        <td class="achieveName"><?php echo ($vo["demand"]); ?></td>
                        <td class="achieveName"><?php echo ($vo["achievement"]); ?></td>
        ...
        <?php if(isset($dataList)): ?><div class="remark" style="margin-top:20px;"><?php echo ($remark); ?></div><?php endif; ?>
    </div>
...
-->
    <div class="re-cart">
        <div class="cartbox" style="margin:20px auto;">
            ...
            <a href="<?php echo U('Search/index/',array('id'=>42));?>" class="cart-left-box4">历年分数</a>
