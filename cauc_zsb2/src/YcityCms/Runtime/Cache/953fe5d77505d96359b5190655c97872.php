...
<div class="breadcrumbs">
    <div class="bfont">当前位置：<a href="__ROOT__/">首页</a> > <a href="<?php echo U('Search/scorenav',array('id'=>42));?>">历年分数</a></div>
</div>
<div class="re-breadcrumbs">
    <div class="bfont"><a href="__ROOT__/">首页</a> >&nbsp;<a href="<?php echo U('Search/scorenav',array('id'=>42));?>">历年分数</a></div> </div>
</div>
<!--按批次查询、按专业查询入口-->
<style>
    #entrance a {
...
<div class="cart">
    <div class="cart_link" id="entrance">
        <a href="<?php echo U('Search/score1/',array('id'=>42));?>" class="cart-box4" >按专业查询</a>
        <a href="<?php echo U('Search/score2/',array('id'=>42));?>" class="cart-box4" >按批次查询 </a>
    </div>
</div>
<div class="re-cart">
    <div class="cartbox">
        <a href="<?php echo U('Search/score1/',array('id'=>42));?>" class="cart-left-box4">按专业查询</a>
        <a href="<?php echo U('Search/score2/',array('id'=>42));?>" class="cart-left-box4">按批次查询</a>
    </div>
</div>
</div>
<script type="text/javascript">
    ...
    // var zydm = "<?php echo ($zydm); ?>";
    // var kldm = "<?php echo ($kldm); ?>";
    // $.ajax({
...
//                 url: "<?php echo U('Search/charts');?>&province=" + pid + "&year=" + year + "&zydm=" + majorid + "&kldm=" + kldm,
                type: 'get',
           dataType: 'jsonp',
           jsonp: "callback",
                success: function (result) {
