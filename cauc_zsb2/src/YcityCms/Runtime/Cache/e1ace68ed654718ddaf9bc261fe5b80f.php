...
<div class="breadcrumbs">
    <div class="bfont">当前位置：<a href="__ROOT__/">首页</a> > <a href="<?php echo U('Brief/index');?>">走进航大</a></div>
</div>
<div class="re-breadcrumbs">
    <div class="bfont"><a href="__ROOT__/">首页</a> >&nbsp;<a href="<?php echo U('Brief/index');?>">走进航大</a></div> </div>
</div>
<div class="listmain">
    <div class="cont_v">
        <div class="title3" style="margin-bottom:30px;margin-top:-10px;">
            <span>走进航大</span>
        </div>
        <?php if($data['attach_file'] != ''): ?><iframe src='Uploads/<?php echo ($data["attach_file"]); ?>' class="pdf"></iframe>
            <?php else: ?>
            <div style="float:left;margin-left:10px;">暂无简介</div><?php endif; ?>
    </div>
</div>
</div>
