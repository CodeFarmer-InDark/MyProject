    ...
    <div class="search-condition">
        <form action="<?php echo U('Search/score',array('id'=>42));?>" method="get" class="search-box" onsubmit="addStr()">
            ...
            <select name="kldm" id="kldm" class="major-item">
                ...
                <?php if(is_array($kl)): $k = 0; $__LIST__ = $kl;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k; if($kldm == $k): ?><option value="<?php echo ($k); ?>" selected><?php echo ($vo); ?></option>
                    <?php else: ?>
                        <option value="<?php echo ($k); ?>"><?php echo ($vo); ?></option><?php endif; endforeach; endif; else: echo "" ;endif; ?>
            </select>
