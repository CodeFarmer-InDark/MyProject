	...
	function $doc(id){
        ...
        <!-- Main Content Section with everything -->
			...
			<ul class="shortcut-buttons-set">
                ...
                <li><a class="shortcut-button" href="<?php echo U("Register/doExport");?>"><span>
			...
			<div class="content-box"><!-- Start Content Box -->
				...
				<div class="content-box-content">
                	<form method="post" action="<?php echo U("Register/doCommand");?>" id="mainFrom">
...
<?php if(isset($dataList)): ?><tfoot>
                            ...
                            <?php if(is_array($dataList)): $i = 0; $__LIST__ = $dataList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
									...
									<td><?php if($vo['gender'] == 1): ?>男<?php else: ?>女<?php endif; ?></td>
									<td><?php echo ($vo["province"]); ?></td>
									<td><?php echo ($vo["id_no"]); ?></td>
									<td><?php echo ($vo["candidate_no"]); ?></td>
