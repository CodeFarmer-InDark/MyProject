    ...
    <!-- End #sidebar -->
        ...
        <!-- Main Content Section with everything -->
			...
			<ul class="shortcut-buttons-set">
                ...
                <li><a class="shortcut-button" href="<?php echo U("Subject/import");?>"><span>
			...
			<div class="content-box"><!-- Start Content Box -->
				...
				<div class="content-box-content">
                    ...
                    <form method="post" action="<?php echo U("Subject/doCommand");?>">
						<?php if(isset($remark)): ?><div class="notification information png_bg">
...
<?php if(is_array($dataList)): $i = 0; $__LIST__ = $dataList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
									...
									<td><?php echo ($vo["subjectdemand"]); ?></td>
									<td><?php echo ($vo["signdemand"]); ?></td>
									<td>
										<!-- Icons -->
										<a href="<?php echo U("Subject/modify",array('id'=>$vo['id']));?>" title="编辑"><img src="__PUBLIC__/Admin/images/icons/pencil.png" alt="编辑" /></a>
                                        <a href="<?php echo U("Subject/doCommand",array('operate'=>'delete','id'=>$vo['id']));?>" title="删除"><img src="__PUBLIC__/Admin/Images/icons/cross.png" alt="删除" /></a>
									</td>
