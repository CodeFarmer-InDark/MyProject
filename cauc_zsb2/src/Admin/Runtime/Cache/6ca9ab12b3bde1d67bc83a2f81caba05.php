	...
	$(document).ready(function() {
        ...
        <!-- Main Content Section with everything -->
			...
			<ul class="shortcut-buttons-set">
                ...
                <li><a class="shortcut-button" href="<?php echo U("Subject/index");?>"><span>
			...
			<div class="content-box"><!-- Start Content Box -->
				...
				<div class="content-box-content">
					<div class="tab-content default-tab" id="tab1"> <!-- This is the target div. id must match the href of this div's tab -->
                    	<form method="post" action="<?php echo U("Subject/doModify");?>" enctype="multipart/form-data" id="mainFrom">
							<fieldset class="column-left"> <!-- Set class to "column-left" or "column-right" on fieldsets to divide the form into columns -->
								...
								<p>
									<label>考试科目要求</label>
									<input class="text-input medium-input" type="text" name="subjectdemand" id="subjectdemand" value="<?php echo ($vo["subjectdemand"]); ?>">
								</p>
								...
								<p>
									...
									<select name="province" id="province" >
										...
										<?php if(is_array($provinceArr)): $i = 0; $__LIST__ = $provinceArr;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$p): $mod = ($i % 2 );++$i;?><option value="<?php echo ($p["province"]); ?>"><?php echo ($p["province"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
									</select>
								</p>
								<p style="margin-bottom:-10px;">
									<label>考生报考要求</label>
									<textarea name="signdemand" id="signdemand" rows="5"  ><?php echo ($vo["signdemand"]); ?>
									 </textarea>
								</p>
								<p>
									<label>更新时间</label>
							...
							<fieldset class="column-right"> <!-- Set class to "column-left" or "column-right" on fieldsets to divide the form into columns -->
								<p>
									<label>专业方向</label>
									<input class="text-input medium-input" type="text" name="direction" id="direction" value="<?php echo ($vo["direction"]); ?>">
								</p>
								<p>
									<label>层次</label>
									<input class="text-input medium-input" type="text" name="level" id="level" value="<?php echo ($vo["level"]); ?>">
								</p>
							</fieldset>
