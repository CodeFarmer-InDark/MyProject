        ...
        <!-- Main Content Section with everything -->
			...
			<div class="content-box"><!-- Start Content Box -->
				...
				<div class="content-box-content">
                	<form method="post" action="<?php echo U("Consult/doCommand");?>" id="mainFrom">
...
<?php if(isset($dataList)): ?><tfoot>
                            ...
                            <?php if(is_array($dataList)): $i = 0; $__LIST__ = $dataList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
									...
									<td><?php echo (statusicon($vo["status"],1,$frontUrl,'images/icons/cross_circle.png','隐藏')); echo (attachstatus($vo["attach"],1,$frontUrl,'images/icons/image.png','图片')); echo (statusicon($vo["istop"],1,$frontUrl,'images/icons/arrow_up_green.png','置顶')); ?></td>
									<td></td>
									...
									<td>
										<!-- Icons -->
										<a href="<?php echo U('Consult/modify',array('id'=>$vo['id']));?>" title="编辑"><img src="__PUBLIC__/Admin/Images/icons/pencil.png" alt="编辑" /></a>
										<a href="<?php echo U('Consult/doCommand',array('operate'=>'delete','id'=>$vo['id']));?>" title="删除"><img src="__PUBLIC__/Admin/Images/icons/cross.png" alt="删除" /></a>
									</td>
