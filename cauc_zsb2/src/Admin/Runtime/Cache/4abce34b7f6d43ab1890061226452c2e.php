	...
	function $doc(id){
        ...
        <!-- Main Content Section with everything -->
			...
			<ul class="shortcut-buttons-set">
                ...
                <li><a class="shortcut-button" href="<?php echo U("College/index");?>"><span>
			...
			<div class="content-box"><!-- Start Content Box -->
				...
				<div class="content-box-content">
					<form method="post" action="<?php echo U("College/doModify");?>" id="mainFrom" enctype="multipart/form-data">
					<div class="tab-content default-tab" id="tab1"> <!-- This is the target div. id must match the href of this div's tab -->
						<fieldset class="column-left"> <!-- Set class to "column-left" or "column-right" on fieldsets to divide the form into columns -->
							<p>
								<label>名称 <span style="padding-left:365px;">方向</span></label>
								<input class="text-input medium-input" type="text" name="title" id="title" value="<?php echo ($vo["title"]); ?>"/> <input type="text" class="text-input" name="zyfx" value="<?php echo ($vo["zyfx"]); ?>">
							</p>
						</fieldset>
					...
					<div class="tab-content" id="tab2"> <!-- This is the target div. id must match the href of this div's tab -->
						<fieldset class="column-left">
							<p>
								<label>学院网址</label>
								<input class="text-input medium-input" type="text" name="web_url" id="web_url" value="<?php echo ($vo["web_url"]); ?>"/>
							</p>
							<p>
								<label>咨询电话</label>
								<input class="text-input medium-input" type="text" name="phone" id="phone" value="<?php echo ($vo["phone"]); ?>" />
							</p>
							<p>
								<label>其它参数</label>
