        	...
        	<div id="sidebar-wrapper">
                ...
                <ul id="main-nav">  <!-- Accordion Menu -->
                    ...
                    <!--<li>-->
                        ...
                        <!--<ul>-->
                            <!--&lt;!&ndash;<li class="Plan"><a href="<?php echo U("Plan/index");?>" <?php if(($moduleName == 'Plan')): ?>class="current"<?php endif; ?>>招生计划管理</a></li>&ndash;&gt;-->
                            <!--<li class="Subject"><a href="<?php echo U("Subject/index");?>" <?php if(($moduleName == 'Subject')): ?>class="current"<?php endif; ?>>选考科目管理</a></li>-->
                            <!--&lt;!&ndash;<li class="Score"><a href="<?php echo U("Score/index");?>" <?php if(($moduleName == 'Score')): ?>class="current"<?php endif; ?>>历年分数管理</a></li>&ndash;&gt;-->
                        <!--</ul>-->
                    <!--</li>-->
                    <li>
    ...
    $(document).ready(function() {
        ...
        <!-- Main Content Section with everything -->
			...
			<ul class="shortcut-buttons-set">
                ...
                <li><a class="shortcut-button" href="<?php echo U("Major/index");?>"><span>
			...
			<div class="content-box"><!-- Start Content Box -->
				...
				<div class="content-box-content">
					<div class="tab-content default-tab" id="tab1"> <!-- This is the target div. id must match the href of this div's tab -->
                    	<form method="post" action="<?php echo U("Major/doModify");?>" enctype="multipart/form-data" id="mainFrom">
							<fieldset class="column-left"> <!-- Set class to "column-left" or "column-right" on fieldsets to divide the form into columns -->
								<p>
									<label>学院</label>
									<input class="text-input medium-input" type="text" name="college" id="college" value="<?php echo ($vo["college"]); ?>">
								</p>
								<p>
									<label>专业名称</label>
									<input class="text-input medium-input" type="text" name="major" id="major" value="<?php echo ($vo["major"]); ?>">
								</p>
								<p>
									<label>学制</label>
									<input class="text-input small-input" type="text" name="length" id="length" value="<?php echo ($vo["length"]); ?>">
								</p>
								<p>
									<label>科类</label>
									<input class="text-input small-input" type="text" name="type" id="type" value="<?php echo ($vo["type"]); ?>">
								</p>
								<p>
									<label>计划数</label>
									<input class="text-input small-input" type="text" name="target" id="target" value="<?php echo ($vo["target"]); ?>">
								</p>
								<p>
									<label>学费</label>
									<input class="text-input small-input" type="text" name="fee" id="fee" value="<?php echo ($vo["fee"]); ?>">
								</p>
								<p style="margin-bottom:-10px;">
									<label>报考要求</label>
									<textarea name="demand" id="demand" rows="5"  ><?php echo ($vo["demand"]); ?>
									 </textarea>
								</p>
								<p style="margin-bottom:-10px;">
									<label>专业建设项目成果</label>
									<textarea name="achievement" id="achievement" rows="5"  ><?php echo ($vo["achievement"]); ?>
									 </textarea>
								</p>
								<p>
									<label>更新时间</label>
