		...
		<div id="sidebar">
        	<div id="sidebar-wrapper">
                ...
                <ul id="main-nav">  <!-- Accordion Menu -->
                    ...
                    <li>
                        <a href="#" class='nav-top-item no-submenu <?php if(($moduleName == Plan) OR ($moduleName == Score) OR ($moduleName == Subject)): ?>current<?php endif; ?>'>查询管理</a>
                        <ul>
    ...
    $(document).ready(function() {
        ...
        <!-- Main Content Section with everything -->
			...
			<ul class="shortcut-buttons-set">
                ...
                <li><a class="shortcut-button" href="<?php echo U("Adv/index");?>"><span>
			...
			<div class="content-box"><!-- Start Content Box -->
				...
				<div class="content-box-content">
                    <form method="post" action="<?php echo U("Adv/doModify");?>" id="mainFrom" enctype="multipart/form-data">
					<div class="tab-content default-tab" id="tab1"> <!-- This is the target div. id must match the href of this div's tab -->
                        ...
                        <fieldset>
                            ...
                            <br /><small style="color:#f00">已经上传附件，若不更换则不必重新选择附件</small><?php endif; ?>
                                <br /><small>.png,.gif,.jpg；建议图片大小1747*687</small>
                            </p>
                            <p>
                                <label>排序</label>
