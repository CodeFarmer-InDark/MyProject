...
<div id="main-content">
	...
	<div class="content-box"><!-- Start Content Box -->
		...
		<div class="content-box-content">
			<form method="post" action="<?php echo U("College/doInsert");?>" id="mainFrom" enctype="multipart/form-data">
			<div class="tab-content default-tab" id="tab1"> <!-- This is the target div. id must match the href of this div's tab -->
				<fieldset class="column-left"> <!-- Set class to "column-left" or "column-right" on fieldsets to divide the form into columns -->
					<p>
						<label>名称 <span style="padding-left:365px;">方向</span></label>
						<input class="text-input medium-input" type="text" name="title" id="title" /> <input type="text" class="text-input" name="zyfx" >
					</p>
				</fieldset>
			...
			<div class="tab-content" id="tab2"> <!-- This is the target div. id must match the href of this div's tab -->
				<fieldset class="column-left">
					<p>
						<label>学院网址</label>
						<input class="text-input medium-input" type="text" name="web_url" id="web_url" />
					</p>
					<p>
						<label>咨询电话</label>
