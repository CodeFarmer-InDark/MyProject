			...
			<div class="content-box"><!-- Start Content Box -->
				...
				<div class="content-box-content">
					...
					<div class="tab-content" id="tab3"> <!-- This is the target div. id must match the href of this div's tab -->
                        ...
                        <fieldset>
                            <p>
                                <label>使用招生系统接口查询招生计划凭据</label>
                                <input class="text-input small-input" type="text" id="appid" name="appid" value="<?php echo ($vo["appid"]); ?>" />
                                <small>AppId</small>
                            </p>
                            <p>
                                <input class="text-input small-input" type="text" id="appsecret" name="appsecret" value="<?php echo ($vo["appsecret"]); ?>" />
                            ...
                            <p>
                                <label>是否开启录取结果/录取进度查询</label>
                                <select class="small-input" name="isadmission" id="isadmission">
                                    <option value="1" <?php echo (selected($vo["isadmission"],1)); ?>>开启</option>
                                    <option value="0" <?php echo (selected($vo["isadmission"],0)); ?>>关闭</option>
                                </select>
                            </p>
                            <p>
                                <label>关闭录取结果查询说明</label>
                                <textarea class="text-input textarea" name="admission_remark" cols="79" rows="6" id="admission_remark"><?php echo ($vo["admission_remark"]); ?></textarea>
                            </p>
                            <p>
                                <label>新生大数据统计年份设置</label>
                                <select class="small-input" name="static_year" id="static_year">
                                    <option value="<?php echo ($thisyear); ?>" <?php echo (selected($vo["static_year"],$thisyear)); ?>><?php echo ($thisyear); ?></option>
                                    <option value="<?php echo ($afteryear); ?>" <?php echo (selected($vo["static_year"],$afteryear)); ?>><?php echo ($afteryear); ?></option>
                                </select>
                            </p>
                            <p>
								<label>系统日志</label>
