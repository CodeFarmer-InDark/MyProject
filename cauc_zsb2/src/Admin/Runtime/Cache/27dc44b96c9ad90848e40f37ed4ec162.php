				...
				<div class="content-box-content">
					<div class="tab-content default-tab"> <!-- This is the target div. id must match the href of this div's tab -->
                    	<div class="notification information png_bg">
							...
							<div>
								默认超级用户、普通用户及禁止访问角色组不允许编辑或删除。角色组被删除后，所有组内用户自动移至禁止访问组，该组用户将不能进入后台管理，请谨慎设置。
							</div>
						</div>
						<table>
							<thead>
...
<?php if(is_array($dataList)): $i = 0; $__LIST__ = $dataList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
									...
									<td>
										<!-- Icons -->
                                    <?php if($vo['id'] == 1): ?><img src="__PUBLIC__/Admin/Images/icons/lock.png" alt="锁定" align="absmiddle" />
									<?php elseif($vo['id'] == 2): ?>
                                        <img src="__PUBLIC__/Admin/Images/icons/lock.png" alt="锁定" align="absmiddle" />
										<?php elseif($vo['id'] == 3): ?>
										<img src="__PUBLIC__/Admin/Images/icons/lock.png" alt="锁定" align="absmiddle" />
                                    <?php else: ?>
                                        <a href="<?php echo U("Role/modify",array('id'=>$vo['id']));?>"><img src="__PUBLIC__/Admin/Images/icons/pencil.png" alt="编辑" align="absmiddle" /></a>
                                    <?php if(($vo['id']) != "3"): ?><a href="<?php echo U("Role/doCommand",array('operate'=>'delete','id'=>$vo['id']));?>" class="confirmSubmit"><img src="__PUBLIC__/Admin/Images/icons/cross.png" alt="删除" align="absmiddle" /></a><?php endif; endif; ?>
									</td>
