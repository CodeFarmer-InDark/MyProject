					...
					<form method="get" action="__URL__">
						<div class="tab-content default-tab"> <!-- This is the target div. id must match the href of this div's tab -->
							<fieldset class="column-left">
								...
								<p>
									<input class="button" type="submit" id="submit" value="搜索" /> <a href="__URL__" >默认</a>
								</p>
							</fieldset>
							<fieldset class="column-right">
								<p>
									<label class="left">所属分类</label>
									<select name="categoryId" id="categoryId" class="small-input">
										<option value="0">--</option>
										<?php if(is_array($category)): $i = 0; $__LIST__ = $category;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["id"]); ?>"><?php if($vo["parent_id"] == '27'): ?>招生类型 > <?php echo ($vo["title"]); ?> <?php elseif($vo["parent_id"] == 33): ?>招生咨询 > <?php echo ($vo["title"]); ?> <?php else: echo ($vo["title"]); endif; ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
									</select>
								</p>
								<script type="text/javascript">
									/*
						...
						<!--<fieldset class="column-left1">-->
							...
							<!--<p>-->
								...
								<!--<select name="categoryId" id="categoryId">-->
									<!--<option value="0">&#45;&#45;</option>-->
									<!--<?php if(is_array($category)): $i = 0; $__LIST__ = $category;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["id"]); ?>"><?php echo ($vo["description"]); ?>-<?php echo ($vo["title"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>-->
								<!--</select>-->
							<!--</p>-->
							<!--<p>-->
...
<?php if(isset($dataList)): ?><tfoot>
                            ...
                            <?php if(is_array($dataList)): $i = 0; $__LIST__ = $dataList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
									...
									<td><?php echo (statusicon($vo["status"],1,$frontUrl,'Images/icons/cross_circle.png','隐藏')); ?>
										<?php echo (attachstatus($vo["attach"],1,$frontUrl,'Images/icons/image.png','附件')); ?>
										<?php echo (statusicon($vo["istop"],1,$frontUrl,'Images/icons/arrow_up_green.png','置顶')); ?></td>
