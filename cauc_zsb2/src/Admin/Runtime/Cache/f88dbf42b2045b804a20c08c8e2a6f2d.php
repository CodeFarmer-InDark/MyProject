				...
				<div class="content-box-content">
					...
					<div class="tab-content default-tab"> <!-- This is the target div. id must match the href of this div's tab -->
                        <fieldset class="column-left">
                            <p>
								<label class="left">名　　称</label><input class="text-input medium-input" type="text" name="title" id="title" />
							</p>
							<p>
...
*/
	...
	$("#pageSize").val('<?php echo ($_GET['pageSize']); ?>');
			...
			<div class="content-box"><!-- Start Content Box -->
				...
				<div class="content-box-content">
                	<form method="post" action="<?php echo U("Video/doCommand");?>" id="mainForm">
...
<?php if(isset($dataList)): ?><tfoot>
									...
									<td colspan="7">
										<div class="bulk-actions align-left">
                                            <select name="operate" id="operate">
                                            	...
                                            	<option value="setTop">推荐至首页</option>
                                            	<option value="unSetTop">取消推荐</option>
                            ...
                            <?php if(is_array($dataList)): $i = 0; $__LIST__ = $dataList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
									...
									<td><?php echo (statusicon($vo["status"],1,$frontUrl,'Images/icons/cross_circle.png','隐藏')); echo (statusicon($vo["istop"],1,$frontUrl,'Images/icons/arrow_up_green.png','置顶')); ?></td>
									...
									<td>
										<!-- Icons -->
										<a href="<?php echo U('Video/modify',array('id'=>$vo['id']));?>" title="编辑"><img src="__PUBLIC__/Admin/Images/icons/pencil.png" alt="编辑" /></a>
										<a href="<?php echo U('Video/doCommand',array('operate'=>'delete','id'=>$vo['id']));?>" title="删除"><img src="__PUBLIC__/Admin/Images/icons/cross.png" alt="删除" /></a>
									</td>
