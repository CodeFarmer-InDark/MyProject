...
<div id="main-content">
	...
	<noscript>
		...
		<div class="notification error png_bg">
			<div>
				您的浏览器不支持Javascript或者已经禁用了Javascript。请升级您的浏览器或者<a
					href="http://www.google.com/support/bin/answer.py?answer=23852"
					title="如何启用 JavaScript">启用</a>Javascript支持才能正确浏览页面.
			</div>
		</div>
	</noscript>
	<!-- Page Head -->
	...
	<ul class="shortcut-buttons-set">
		...
		<li><a class="shortcut-button" href="<?php echo U("Major/import");?>"> <span>
				<img src="__PUBLIC__/Admin/Images/icons/database_add_48.png" alt="icon" /><br />
				导入信息
				</span></a></li>
		<li><a class="shortcut-button" href="<?php echo U("Major/deleteAll");?>"> <span>
	...
	<div class="content-box">
		...
		<div class="content-box-content">
			<div class="tab-content default-tab">
				...
				<form method="post" action="<?php echo U("Major/doCommand");?>"> <?php if(isset($remark)): ?><div class="notification information png_bg">
						<a href="#" class="close"><img src="__PUBLIC__/Admin/Images/icons/cross_grey_small.png"
					...
					<table>
						<thead>
							<tr>
								<th><input class="check-all" type="checkbox" id="chkall" name="chkall" value="<?php echo ($vo["id"]); ?>">
								</th>
								<th>ID</th>
								<th>学院</th>
								<th>专业名称</th>
						...
						<?php if(isset($dataList)): ?><tfoot>
							...
							<tbody>
								<?php if(is_array($dataList)): $i = 0; $__LIST__ = $dataList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
										...
										<td><?php echo ($vo["id"]); ?><input name="updateid[]" type="hidden" id="updateid[]"
												value="<?php echo ($vo["id"]); ?>" /></td>
										<td><?php echo ($vo["college"]); ?></td>
										<td><?php echo ($vo["major"]); ?></td>
										<td><?php echo ($vo["length"]); ?></th>
										<td><?php echo ($vo["type"]); ?></td>
										<td><?php echo ($vo["target"]); ?></td>
										<td><?php echo ($vo["fee"]); ?></td>
										<td><?php echo ($vo["demand"]); ?></td>
										<td><?php echo ($vo["achievement"]); ?></td>
										<td>
											<!-- Icons -->
											<a href="<?php echo U("Major/modify",array('id'=>$vo['id']));?>" title="编辑"><img
													src="__PUBLIC__/Admin/images/icons/pencil.png" alt="编辑" /></a>
											<a href="<?php echo U("Major/doCommand",array('operate'=>'delete','id'=>$vo['id']));?>"
												title="删除"><img src="__PUBLIC__/Admin/Images/icons/cross.png"
													alt="删除" /></a>
										</td>
