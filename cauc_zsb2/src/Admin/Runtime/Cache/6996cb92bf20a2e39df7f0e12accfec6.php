...
<!-- Wrapper for the radial gradient background -->
        ...
        <!-- Main Content Section with everything -->
			...
			<ul class="shortcut-buttons-set">
                ...
                <li><a class="shortcut-button" href="<?php echo U("Score/index");?>"><span>
			...
			<div class="content-box"><!-- Start Content Box -->
				...
				<form method="post" action="<?php echo U("Score/doDelete");?>" id="mainFrom" enctype="multipart/form-data">
					<div class="tab-content default-tab" id="tab1"> <!-- This is the target div. id must match the href of this div's tab -->
						<fieldset class="column-left"> <!-- Set class to "column-left" or "column-right" on fieldsets to divide the form into columns -->
							<p>
								<label>清空指定年份信息</label>
								<select name="yearExist" id="yearExist" class="small-input">
									<option value="0">--</option>
									<?php if(is_array($yearExt)): $i = 0; $__LIST__ = $yearExt;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["year"]); ?>"><?php echo ($vo["year"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
								</select>
							</p>
						</fieldset>
						<div class="clear"></div><!-- End .clear -->
						<p>
							<input class="button" type="submit" name="submit" value="清空"/>
						</p>
					</div> <!-- End #tab1 -->
				</form>
