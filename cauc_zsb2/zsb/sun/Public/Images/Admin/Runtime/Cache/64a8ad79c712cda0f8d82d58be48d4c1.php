    ...
    $(document).ready(function() {
        ...
        <!-- Main Content Section with everything -->
			...
			<ul class="shortcut-buttons-set">
                ...
                <li><a class="shortcut-button" href="<?php echo U("Role/insert");?>"><span>
					<img src="__PUBLIC__/Admin/Images/icons/users_two_add_48.png" alt="icon" /><br />
					添加管理员角色组
				</span></a></li>
			...
			<div class="content-box"><!-- Start Content Box -->
				...
				<div class="content-box-content">
                    ...
                    <form method="post" action="<?php echo U("Role/doModify");?>" enctype="multipart/form-data" id="mainForm">
						<table>
							<thead>
								<tr>
                                   <th>角色组名称</th>
								   <th><input class="text-input small-input" name="role_name" id="role_name" value="<?php echo ($vo["role_name"]); ?>"></th>
								</tr>
							</thead>
							<tbody>
<?php if(is_array($dataList)): $i = 0; $__LIST__ = $dataList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$dataVo): $mod = ($i % 2 );++$i;?><tr>
									<td><?php echo ($dataVo["module_title"]); ?></td>
									<td><?php echo (exploderole($dataVo["module_permission"],$vo['role_permission'])); ?></td>
								</tr><?php endforeach; endif; else: echo "" ;endif; ?>
								<tr>
                                	<td colspan="2"><input type="checkbox" id="chkall" name="chkall" class="check-all">全选(不选择表示拥有全部权限)</td>
								</tr>
                                <tr>
                                	<td colspan="2">
                                    	<input class="button" type="submit" name="submit" value="提交编辑">
