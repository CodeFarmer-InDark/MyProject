        ...
        <!-- Main Content Section with everything -->
			...
			<div class="content-box"><!-- Start Content Box -->
				...
				<div class="content-box-content">
                    ...
                    <form method="post" action="<?php echo U("Role/doInsert");?>" enctype="multipart/form-data" id="mainForm">
						<table>
							<thead>
								<tr>
                                   <th style="width: 100px">角色组名称</th>
...
<?php if(is_array($dataList)): $i = 0; $__LIST__ = $dataList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$dataVo): $mod = ($i % 2 );++$i;?><tr>
									...
									<td><?php echo (exploderole($dataVo["module_permission"])); ?></td>
