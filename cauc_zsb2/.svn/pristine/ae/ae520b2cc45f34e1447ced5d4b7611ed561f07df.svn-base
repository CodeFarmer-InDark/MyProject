        ...
        <!-- Main Content Section with everything -->
			...
			<div class="content-box"><!-- Start Content Box -->
				...
				<div class="content-box-content">
                	<form method="post" action="<?php echo U('Link/doCommand');?>" id="mainFrom">
...
<?php if(isset($dataList)): ?><tfoot>
                            ...
                            <?php if(is_array($dataList)): $i = 0; $__LIST__ = $dataList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
									...
									<td><input class="text-input large-input" name="LinkText[]" id="LinkText[]" value="<?php echo ($vo["LinkText"]); ?>" style="<?php echo ($vo["title_style"]); ?>"></td>
                                    <td><?php echo (statusicon($vo["status"],1,$frontUrl,'Images/icons/cross_circle.png','隐藏')); echo (statusicon($vo["LinkStatus"],1,$frontUrl,'Images/icons/accepted.png','显示')); echo (attachstatus($vo["link_type"],'image',$frontUrl,'Images/icons/image.png','图片')); ?></td>
									<td><?php echo ($vo["gtitle"]); ?></td>
									<td><input class="text-input large-input" name="LinkURL[]" id="link_url[]" value="<?php echo ($vo["LinkURL"]); ?>" /></td>
									<td>
										<!-- Icons -->
