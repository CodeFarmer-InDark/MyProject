...
<div class="body grey">
    <div class="register pad fff bottom" style="min-height:500px;">
        <div class="rtitle">
            <span class="t1">历史报名</span>
        </div>
        <div class="historylist">
            <?php if(isset($dataList)): if(is_array($dataList)): $i = 0; $__LIST__ = $dataList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><a href="<?php echo U('History/detail',['id'=>$vo['id']]);?>" class="itembox">
                        <span class="h1">学校：<?php echo ($vo["zxmc"]); ?></span>
                        <span class="h2">报名人数：<?php echo ($vo["bmCount"]); ?></span>
                        <span class="h3">审批人数：<?php echo ($vo["checkCount"]); ?></span>
                        <span style="color:#000;">审核状态：</span>
                ...
                <div class="clear"></div>
                <?php else: ?>
                <p class="no" style="padding:30px;">暂无数据</p><?php endif; ?>
    </div>
</div>
</div>
    <footer>
