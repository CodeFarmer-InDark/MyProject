	...
	$(document).ready(function() {
        ...
        <!-- Main Content Section with everything -->
			...
			<ul class="shortcut-buttons-set">
                ...
                <li><a class="shortcut-button" href="<?php echo U("Teacher/insert");?>"><span>
			...
			<div class="content-box"><!-- Start Content Box -->
				...
				<div class="content-box-content">
					<div class="tab-content default-tab"> <!-- This is the target div. id must match the href of this div's tab -->
                    	<form method="post" action="<?php echo U("Teacher/doModify");?>" enctype="multipart/form-data" id="mainFrom">
							...
							<fieldset> <!-- Set class to "column-left" or "column-right" on fieldsets to divide the form into columns -->
								...
								<p>
									...
									<select name="college" id="college" onchange="style_show(this)" >
										<option value="<?php echo ($vo["college"]); ?>"><?php echo ($college); ?></option>
										<?php if(is_array($cate_college)): $i = 0; $__LIST__ = $cate_college;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$row): $mod = ($i % 2 );++$i;?><option value="<?php echo ($row["id"]); ?>"><?php echo ($row["title"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
									</select>
								</p>
								<p>
									<label>职称</label>
									<select name="position" id="position" onchange="style_show(this)" >
										<option value="<?php echo ($vo["position"]); ?>"><?php echo ($position); ?></option>
										<?php if(is_array($cate_position)): $i = 0; $__LIST__ = $cate_position;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$row): $mod = ($i % 2 );++$i;?><option value="<?php echo ($row["id"]); ?>"><?php echo ($row["title"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
									</select>
								</p>
								<p>
									<label>导师类别</label>
									<select name="type" id="type" onchange="style_show(this)" >
										<option value="<?php echo ($vo["type"]); ?>"><?php echo ($type); ?></option>
										<?php if(is_array($cate_type)): $i = 0; $__LIST__ = $cate_type;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$row): $mod = ($i % 2 );++$i;?><option value="<?php echo ($row["id"]); ?>"><?php echo ($row["title"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
									</select>
								</p>
								<p></p>
							</fieldset>
						...
						<fieldset>
							...
							<script type="text/plain" id="content" name="content" style="height:400px;"> <?php echo ($vo["content"]); ?></script>
							<script type="text/javascript">
