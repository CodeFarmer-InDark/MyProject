...
CREATE TABLE `ycity_admin_log` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=2279 DEFAULT CHARSET=utf8 CHECKSUM=1 DELAY_KEY_WRITE=1 ROW_FORMAT=DYNAMIC COMMENT='管理员操作日志';
-- 
-- 导出表中的数据 `ycity_admin_log`
--
INSERT INTO `ycity_admin_log` VALUES ('2271','1','admin','/Admin.php/Database','192.168.1.100','1383460128');
INSERT INTO `ycity_admin_log` VALUES ('2272','1','admin','/Admin.php/Core/index','192.168.1.100','1383460449');
INSERT INTO `ycity_admin_log` VALUES ('2273','1','admin','/Admin.php/Core/doCore (编辑内核配置)','192.168.1.100','1383460458');
INSERT INTO `ycity_admin_log` VALUES ('2274','1','admin','/Admin.php/Core','192.168.1.100','1383460461');
INSERT INTO `ycity_admin_log` VALUES ('2275','1','admin','/Admin.php/Core','192.168.1.100','1383616882');
INSERT INTO `ycity_admin_log` VALUES ('2276','1','admin','/Admin.php/Index/index','192.168.1.100','1383616887');
INSERT INTO `ycity_admin_log` VALUES ('2277','1','admin','/Admin.php/Index/index','192.168.1.100','1383617020');
INSERT INTO `ycity_admin_log` VALUES ('2278','1','admin','/Admin.php/Database/index','192.168.1.100','1383701912');
-- 
-- 表的结构 `ycity_category`
-- 
...
--
INSERT INTO `ycity_config` VALUES ('1','cn','乘务学院招生信息网','天津启阳新程科技有限公司','http://127.0.0.1/ycity','Y-city','15100000000','admin@admin.com','15100000000','15100000000','address a','津ICP备11003837号-2','5565907','y_city@qeeyang.com','Y-city','0','系统维护中.....','','','1','1','index,delete,modify,insert,update,login','Windows,Linux,Apple,其它','linux,windows','1','1','100x100','0','5','70','2048000','gif,jpg,png,jpeg','1','300,200','1','300,250','1','300,200','103,144','中国民航大学乘务学院招生信息网','中国民航大学乘务学院招生信息网','中国民航大学乘务学院招生信息网','1306847872','1306847872');
-- 
-- 表的结构 `ycity_group`
-- 
...
--
INSERT INTO `ycity_member` VALUES ('1330800329','nz8864@sina.com','18d59bc4391f88c806fce28ef7d8fb54027ec7e9','梅家福','2','1988-08-21','330402198808210631','13803002087','11','jXmHdeZ7OtRFKoJ9tyxq','4','1383657641','0','0','0.0.0.0','0');
INSERT INTO `ycity_member` VALUES ('1330947667','20020573@163.com','18d59bc4391f88c806fce28ef7d8fb54027ec7e9','梅家福','2','2013-01-01','110101201301018692','','11','VWQT8BpQk9Q8wPQYXJjE','1','1383701597','0','0','0.0.0.0','0');
-- 
-- 表的结构 `ycity_menu`
-- 
...
CREATE TABLE `ycity_message` (
  ...
  `uid` bigint(11) NOT NULL COMMENT '接受者id',
...
--
INSERT INTO `ycity_message` VALUES ('1','1','13092408678','2');
INSERT INTO `ycity_message` VALUES ('2','2','13092408678','2');
INSERT INTO `ycity_message` VALUES ('3','3','13092408678','2');
INSERT INTO `ycity_message` VALUES ('4','4','13092408678','1');
INSERT INTO `ycity_message` VALUES ('5','5','13092408678','1');
INSERT INTO `ycity_message` VALUES ('6','6','13092408678','2');
INSERT INTO `ycity_message` VALUES ('7','7','13092408688','1');
INSERT INTO `ycity_message` VALUES ('8','8','0','2');
INSERT INTO `ycity_message` VALUES ('9','9','13092408678','1');
INSERT INTO `ycity_message` VALUES ('10','10','0','2');
INSERT INTO `ycity_message` VALUES ('11','11','13101485593','1');
...
CREATE TABLE `ycity_qa` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `mid` varchar(255) CHARACTER SET utf8 NOT NULL COMMENT '提问id',
...
-- 导出表中的数据 `ycity_qa`
--
INSERT INTO `ycity_qa` VALUES ('1','13092408678','1','12','考生问答测试1考生问答测试考生问答测试','考生问答测试考生问答测试考生问答测试','考生问答回复考生问答回复考生问答回复','3','1379831594','1379893594');
INSERT INTO `ycity_qa` VALUES ('2','13092408678','1','12','考生问答测试2考生问答测试考生问答测试考生问答测试考生问答测试考生问答测试考','考生问答测试2考生问答测试2考生问答测试2考生问答测试2考生问答测试2考生问答测试2考生问答测试2考生问答测试2考生问答测试2考生问答测试2考生问答测试2考生问答测试2','考生问答回复2考生问答回复2考生问答回复2考生问答回复2考生问答回复2','3','1379831703','1379893594');
INSERT INTO `ycity_qa` VALUES ('3','13092408678','1','12','考生问答测试3考生问答测试考生问答测试','考生问答测试考生问答测试考生问答测试','考生问答回复考生问答回复考生问答回复','3','1379831594','1379893594');
INSERT INTO `ycity_qa` VALUES ('4','13092408678','1','12','考生问答测试4考生问答测试考生问答测试考生问答测试考生问答测试考生问答测试考','考生问答测试2考生问答测试2考生问答测试2考生问答测试2考生问答测试2考生问答测试2考生问答测试2考生问答测试2考生问答测试2考生问答测试2考生问答测试2考生问答测试2','考生问答回复2考生问答回复2考生问答回复2考生问答回复2考生问答回复2','3','1379831703','1379893594');
INSERT INTO `ycity_qa` VALUES ('5','13092408678','1','12','考生问答测试5考生问答测试考生问答测试','考生问答测试考生问答测试考生问答测试','考生问答回复考生问答回复考生问答回复','3','1379831594','1379893594');
INSERT INTO `ycity_qa` VALUES ('6','13092408678','0','12','考生问答测试6考生问答测试考生问答测试考生问答测试考生问答测试考生问答测试考','考生问答测试2考生问答测试2考生问答测试2考生问答测试2考生问答测试2考生问答测试2考生问答测试2考生问答测试2考生问答测试2考生问答测试2考生问答测试2考生问答测试2','','1','1379831703','0');
INSERT INTO `ycity_qa` VALUES ('7','13092408678','1','12','考生问答测试7考生问答测试考生问答测试','考生问答测试考生问答测试考生问答测试','考生问答回复考生问答回复考生问答回复','3','1379831594','1379893594');
INSERT INTO `ycity_qa` VALUES ('8','13092408678','1','12','考生问答测试8考生问答测试考生问答测试考生问答测试考生问答测试考生问答测试考','考生问答测试2考生问答测试2考生问答测试2考生问答测试2考生问答测试2考生问答测试2考生问答测试2考生问答测试2考生问答测试2考生问答测试2考生问答测试2考生问答测试2','考生问答回复2考生问答回复2考生问答回复2考生问答回复2考生问答回复2','3','1379831703','1379893594');
INSERT INTO `ycity_qa` VALUES ('9','13092408678','1','12','考生问答测试9考生问答测试考生问答测试','考生问答测试考生问答测试考生问答测试','考生问答回复考生问答回复考生问答回复','3','1379831594','1379893594');
INSERT INTO `ycity_qa` VALUES ('10','13092408678','1','12','考生问答测试10考生问答测试考生问答测试考生问答测试考生问答测试考生问答测试','考生问答测试2考生问答测试2考生问答测试2考生问答测试2考生问答测试2考生问答测试2考生问答测试2考生问答测试2考生问答测试2考生问答测试2考生问答测试2考生问答测试2','考生问答回复2考生问答回复2考生问答回复2考生问答回复2考生问答回复2','3','1379831703','1379893594');
INSERT INTO `ycity_qa` VALUES ('11','13092408678','1','12','考生问答测试11考生问答测试考生问答测试','考生问答测试考生问答测试考生问答测试','考生问答回复考生问答回复考生问答回复','1','1379831594','1379893594');
INSERT INTO `ycity_qa` VALUES ('12','13092408678','0','12','考生问答测试12考生问答测试考生问答测试考生问答测试考生问答测试考生问答测试','考生问答测试2考生问答测试2考生问答测试2考生问答测试2考生问答测试2考生问答测试2考生问答测试2考生问答测试2考生问答测试2考生问答测试2考生问答测试2考生问答测试2','','1','1379831703','0');
INSERT INTO `ycity_qa` VALUES ('13','13092408678','0','12','考生问答标题测试考生问答标题测试考生问答标题测试','考生问答内容测试考生问答内容测试考生问答内容测试','','1','0','0');
INSERT INTO `ycity_qa` VALUES ('14','13092408678','0','12','考生问答标题测试考生问答标题测试考生问答标题测试','考生问答内容测试考生问答内容测试考生问答内容测试考生问答内容测试考生问答内容测试','','1','1381685843','0');
INSERT INTO `ycity_qa` VALUES ('15','13092408678','0','12','考生问答标题测试考生问答标题测试考生问答标题测试','考生问答内容测试考生问答内容测试考生问答内容测试考生问答内容测试考生问答内容测试','','2','1381685863','0');
INSERT INTO `ycity_qa` VALUES ('16','13092408678','0','12','xss测试','xss测试','','1','1381686183','0');
INSERT INTO `ycity_qa` VALUES ('18','13092408678','0','12','a&#39; or &#39;1&#39;=&#39;1','sql注入','','1','1381686734','0');
INSERT INTO `ycity_qa` VALUES ('19','13101422063','0','0','我要提问测试','看看看看','','1','1381732957','0');
INSERT INTO `ycity_qa` VALUES ('17','13092408678','0','12','&lt;script&gt;','&lt;script type=&quot;text/javascript&quot; src=&quot;http://lib.sinaapp.com/js/jquery/1.9.1/jquery-1.9.1.min.js&quot;&gt;&lt;/script&gt;&lt;iframe src=&quot;http://www.cauc.edu.cn/&quot;&gt;&lt;/iframe&gt;','','1','1381686299','0');
INSERT INTO `ycity_qa` VALUES ('20','13101485593','0','53','家用燃气灶','测试测试测试测试测试测试测试测试测试测试测试侧hi','','1','1381733801','0');
INSERT INTO `ycity_qa` VALUES ('21','13101589241','0','13','提问测试','提问测试','','1','1381979672','0');
INSERT INTO `ycity_qa` VALUES ('22','13101589241','0','13','纷纷废物废物','非我非we范围额外范围分为','','1','1381980625','0');
INSERT INTO `ycity_qa` VALUES ('23','13092408678','1','12','不公开不公开','不公开不公开不公开','不公开不公开不公开','2','1382253635','0');
INSERT INTO `ycity_qa` VALUES ('24','13101589241','1','13','提问测试   提问人测试','提问测试   提问人测试提问测试   提问人测试提问测试   提问人测试提问测试   提问人测试提问测试   提问人测试','惹我惹我惹我','3','1382255220','1382256267');
INSERT INTO `ycity_qa` VALUES ('25','13101589241','1','13','特务他惹我','退热贴额头','few纷纷','3','1382256292','1382256305');
INSERT INTO `ycity_qa` VALUES ('26','13092408678','0','12','省份省份省份省份省份省份','省份省份省份省份省份省份省份省份','','1','1382257421','0');
-- 
-- 表的结构 `ycity_role`
-- 
...
CREATE TABLE `ycity_signup` (
  ...
  `image_thumb` varchar(255) CHARACTER SET utf8 NOT NULL COMMENT '照片缩略图地址',
...
--
INSERT INTO `ycity_signup` VALUES ('1330830316','1','天津城市建设学院','300384','津静公路26号','022-58018980','300380','叶海军2','13622048617','Signup/201311/5278ae782d519.JPG','Signup/201311/5278ae782d519_s.JPG','1383640696','0','2013110521889118','TRADE_SUCCESS','82ac787ed074449db301a9350caa10e130','2013-11-05 20:20:51','20020573@163.com');
INSERT INTO `ycity_signup` VALUES ('1330800384','2','天津城市建设大学','300384','天津市西青区津静公路26号','13662086010','300384','姚晓峰','13662086010','Signup/201311/5278cafce09c0.jpg','Signup/201311/5278cafce09c0_s.jpg','1383647996','0','2013110530728523','TRADE_SUCCESS','f1c17e386378f0cf5179c1cb77948a7b3a','2013-11-05 20:05:15','285783013@qq.com');
INSERT INTO `ycity_signup` VALUES ('1330865701','1','天津城市建设学院','300384','津静公路26号','022-58018980','300380','叶海军','13622048617','Signup/201311/5278e78c2d519.JPG','Signup/201311/5278e78c2d519_s.JPG','1383655308','0','2013110522589818','TRADE_SUCCESS','7c0d9661ebcba2e299ba2f83baf6c32530','2013-11-05 21:07:45','20020573@163.com');
INSERT INTO `ycity_signup` VALUES ('1330800329','1','天津城市建设学院','300384','津静公路26号','022-58018980','300380','叶海军','13622048617','Signup/201311/5278f0d54fa6a.JPG','Signup/201311/5278f0d54fa6a_s.JPG','1383657685','0','2013110522698318','TRADE_SUCCESS','8f64a8498ef5ba9b6bbf6679565a920730','2013-11-06 06:46:11','20020573@163.com');
-- 
-- 表的结构 `ycity_tags`
-- 
...
-- 导出表中的数据 `ycity_user`
--
INSERT INTO `ycity_user` VALUES ('1','1','admin','d9637d9c684ba63b5b1b05e1f578495a80a0a25a','系统管理员','男','0','05560000000','13900000000','022-58018980','20020573@163.com','5565907','2','','156','1306847872','1306847872','0.0.0.0','1383616881','0');
