...
<script type="text/javascript">
	...
	function $doc(id){
        ...
        <!-- Main Content Section with everything -->
			...
			<div class="content-box closed-box" style="border: none;width: 500px"><!-- Start Content Box -->

				<div class="content-box" style="width: 1000px">
					<form method="get" action="__URL__">
						<p>
							<label class="left">&#12288&#12288标&#12288题</label><input class="text-input " style="width: 400px" type="text" name="title" id="title" />
							<label  style="display: inline">&#12288&#12288id&#12288号</label><input class="text-input " style="width:200px" type="text" name="cid" id="cid" />
							<input class="button" style="margin-left: 20px" type="submit" id="submit" name="submit" value="搜索" />
						</p>
