...
if (!defined('QRCODEDEFS')) {
    ...
    /**
	 * Download point base value for case 1 mask pattern (concatenation of same color in a line or a column)
	 */
    define('N1',  3);

    /**
	 * Download point base value for case 2 mask pattern (module block of same color)
	 */
	define('N2',  3);

    /**
	 * Download point base value for case 3 mask pattern (1:1:3:1:1(dark:bright:dark:bright:dark)pattern in a line or a column)
	 */
	define('N3', 40);

    /**
	 * Download point base value for case 4 mask pattern (ration of dark modules in whole)
	 */
	define('N4', 10);
