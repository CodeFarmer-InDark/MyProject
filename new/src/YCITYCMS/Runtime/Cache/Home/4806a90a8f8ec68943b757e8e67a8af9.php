...
<div class="breadcrumbs">
    <div class="bfont">当前位置：<a href="__ROOT__/">首页</a>><a href="<?php echo U('Contact/index');?>"><?php echo ($moduleTitle); ?></a></div>
</div>
<div class="re-breadcrumbs">
    <div class="bfont"><a href="__ROOT__/">首页</a> > <a href="<?php echo U('Contact/index');?>"><?php echo ($moduleTitle); ?></a></div>
</div>
<div class="listmain">
    <div class="contact">
