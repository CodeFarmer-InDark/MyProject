...
<!-- Wrapper for the radial gradient background -->
        ...
        <!-- Main Content Section with everything -->
			...
			<div class="content-box"><!-- Start Content Box -->
				...
				<div class="content-box-content">
					<div class="tab-content default-tab"> <!-- This is the target div. id must match the href of this div's tab -->
                    <form method="post" action="<?php echo U("Teacher/doCommand");?>">
						<table>
							<thead>
								<tr>
...
<?php if(is_array($dataList)): $i = 0; $__LIST__ = $dataList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
									...
									<td><?php switch($vo["college"]): case "112": ?>材料工程系<?php break; case "111": ?>材料化学系<?php break; case "110": ?>材料科学与工程实验中心<?php break; endswitch;?></td>
                                    <td><?php echo (date("Y-m-d",$vo["create_time"])); ?></td>
									<td>
										<!-- Icons -->
										 <a href="<?php echo U("Teacher/modify",array('id'=>$vo['id']));?>" title="编辑"><img src="__PUBLIC__/Admin/Images/icons/pencil.png" alt="编辑" /></a>
                                         <a href="<?php echo U("Teacher/doCommand",array('operate'=>'delete','id'=>$vo['id']));?>" title="删除"><img src="__PUBLIC__/Admin/Images/icons/cross.png" alt="删除" /></a>
